...
import { db } from './db';
import { THRESHOLDS, encounterMultiplier as multiplier } from '$lib/xp';

const execFileP = promisify(execFile);

// --- Deterministic encounter math (DMG 2014) ---------------------------------
// Threshold/multiplier tables live in $lib/xp so the battle builder's live
// gauge uses the same numbers.
